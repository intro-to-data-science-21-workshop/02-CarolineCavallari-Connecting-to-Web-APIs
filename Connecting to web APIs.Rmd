...
- Client: companies or you, data analysts `r emo::ji("coder")` #from what I understand the term client usually refers to software, like a browser or R studio (when it makes requests to a server)# 
...
.footnote[<sup>2</sup> [image taken from Brian Cooksey explanation on APIs](https://zapier.com/learn/apis/chapter-1-introduction-to-apis/)<br> <sup>3</sup> [the kitchen example was taken from Shana Pearlman "What are APIs and how do APIS work? ](https://blogs.mulesoft.com/learn-apis/api-led-connectivity/what-are-apis-how-do-apis-work/)]
...
.footnote[<sup>2</sup> [MDN Web Docs HHTP Messages](https://developer.mozilla.org/en-US/docs/Web/HTTP/Messages)
...
# i dont understand the difference between step 3 and 4
...
name: Sources consulted for this workshop

#Sources consulted for this workshop
<br>
