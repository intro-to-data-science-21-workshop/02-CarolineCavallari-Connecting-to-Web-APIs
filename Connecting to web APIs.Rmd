...
The client orders the food according to the waiter, and the **waiter** sends this request to the **kitchen (the server)**, who will interpret the request and produce it. 
<br>
